...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: <FaEnvelope className="w-5 h-5 fill-white" />,
      label: 'Email',
    ...
    {
      icon: <FaPhone className="w-5 h-5 fill-white" />,
      label: 'Phone',
      value: '+91 1234567890',
    ...
    {
      icon: <FaMapMarkerAlt className="w-5 h-5 fill-white" />,
      label: 'Location',
    ...
    {
      icon: <FaClock className="w-5 h-5 fill-white" />,
      label: 'Response Time',
  ...
  const socialLinks = [
    ...
    // { icon: <FaRegSmile className="w-5 h-5" />, href: "https://discord.com", label: "Discord", color: "hover:text-indigo-500" }
  ]
    ...
    <div className="min-h-screen bg-linear-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-24 pb-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fadeInUp">
          ...
          <h1 className="text-4xl py-2 lg:text-5xl font-light text-gray-900 dark:text-white mb-4">
            Let's Work&nbsp;
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <FaComment className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-4 h-4 transition-colors ${
                        focusedField === 'subject' ? 'text-purple-600' : 'text-gray-400'
                      }`} />
                      <input
                        type="text"
                        name="subject"
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      required
                      rows="5"
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:border-purple-600 dark:focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-600/20 dark:focus:ring-purple-400/20 text-sm text-gray-900 dark:text-white resize-none transition-all"
                ...
                >
                  ...
                  <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4 hover:border-transparent transition-all duration-300 hover:shadow-lg">
                    <div className={`w-10 h-10 rounded-lg bg-linear-to-r ${item.color} bg-opacity-10 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}>
                      <div className={`text-transparent bg-clip-text bg-linear-to-r ${item.color}`}>
                        {item.icon}
                      </div>
                    </div>
